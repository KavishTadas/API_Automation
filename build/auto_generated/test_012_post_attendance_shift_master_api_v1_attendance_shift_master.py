...
API = json.loads(r"""{
  ...
  "API Identifier": "post|/api/v1/attendance/shift/master|attendance shift master|create new shift",
...
@allure.link("post|/api/v1/attendance/shift/master|attendance shift master|create new shift", name="API Identifier")
