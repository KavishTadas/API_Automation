...
API = json.loads(r"""{
  ...
  "Owner / Developer": "",
  "API Identifier": "post|{{baseurl}}|/api/attendancepolicy|attendance policy master|create new policy",
...
@allure.label("owner", "")
@allure.link("post|{{baseurl}}|/api/attendancepolicy|attendance policy master|create new policy", name="API Identifier")
