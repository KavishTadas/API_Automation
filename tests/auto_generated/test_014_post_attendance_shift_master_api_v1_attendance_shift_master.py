"""Generated tests for API row 14.
...
@allure.title("Create CUSTOM Shift (FIXED Type) \u2014 returns HTTP 200")
@allure.epic("Attendance Shift Master")
@allure.feature("POST /api/v1/attendance/shift/master — Create CUSTOM Shift (FIXED Type)")
@allure.story("HTTP Status Code Check (200)")
@allure.parent_suite("Attendance Shift Master")
@allure.suite("POST /api/v1/attendance/shift/master — Create CUSTOM Shift (FIXED Type)")
...
@allure.title("Create CUSTOM Shift (FIXED Type) \u2014 response matches documented schema")
@allure.epic("Attendance Shift Master")
@allure.feature("POST /api/v1/attendance/shift/master — Create CUSTOM Shift (FIXED Type)")
