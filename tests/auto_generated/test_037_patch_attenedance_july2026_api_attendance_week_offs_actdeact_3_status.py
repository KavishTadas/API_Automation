...
API = json.loads(r"""{
  ...
  "Owner / Developer": "",
  "API Identifier": "patch|https://devmcdphcmplatform.omfysgroup.com|/api/attendance/week-offs/actdeact/3/status|attenedance-july2026|weekoffactdeact",
...
@allure.label("owner", "")
@allure.link("patch|https://devmcdphcmplatform.omfysgroup.com|/api/attendance/week-offs/actdeact/3/status|attenedance-july2026|weekoffactdeact", name="API Identifier")
