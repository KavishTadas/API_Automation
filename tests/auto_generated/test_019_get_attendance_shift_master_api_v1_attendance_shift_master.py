...
API = json.loads(r"""{
  ...
  "Owner / Developer": "",
  "API Identifier": "get|{{baseurl}}|/api/v1/attendance/shift/master|attendance shift master|get all shifts",
...
@allure.label("owner", "")
@allure.link("get|{{baseurl}}|/api/v1/attendance/shift/master|attendance shift master|get all shifts", name="API Identifier")
