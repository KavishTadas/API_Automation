"""Fixtures for the login case tier.

Shares _support with test-cases/endpoint/: login is a separate root only because
both auth endpoints are POST /auth/token and a flat root keeps them apart.
...
sys.path.insert(0, str(ROOT_DIR / "test-cases" / "endpoint"))
