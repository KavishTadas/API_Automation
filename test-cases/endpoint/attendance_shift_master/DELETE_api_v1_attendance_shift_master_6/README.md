...
Suite: `attendance_shift_master` · endpoint slug: `attendance_shift_master_delete_api_v1_attendance_shift_master_6`
...
```python
caseRef = "delete|/api/v1/attendance/shift/master/6|attendance shift master|delete shift"
```
