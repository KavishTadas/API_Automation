...
Suite: `attendance_shift_master` · endpoint slug: `attendance_shift_master_get_api_v1_attendance_shift_master_7`
...
```python
caseRef = "get|/api/v1/attendance/shift/master/7|attendance shift master|get by id"
```
