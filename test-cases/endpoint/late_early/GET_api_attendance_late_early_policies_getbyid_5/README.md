...
Suite: `late_early` · endpoint slug: `late_early_get_api_attendance_late_early_policies_getbyid_5`
...
```python
caseRef = "get|/api/attendance/late-early-policies/getbyid/5|latearly-policy|getbyid/1"
```
