...
Suite: `late_early` · endpoint slug: `late_early_patch_api_attendance_late_early_policies_5_status`
...
```python
caseRef = "patch|/api/attendance/late-early-policies/5/status|latearly-policy|changestatus"
```
