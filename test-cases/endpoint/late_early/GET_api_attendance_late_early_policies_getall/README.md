...
Suite: `late_early` · endpoint slug: `late_early_get_api_attendance_late_early_policies_getall`
...
```python
caseRef = "get|/api/attendance/late-early-policies/getall|latearly-policy|getall"
```
