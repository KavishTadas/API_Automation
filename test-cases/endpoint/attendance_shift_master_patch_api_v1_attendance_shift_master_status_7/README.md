# attendance_shift_master_patch_api_v1_attendance_shift_master_status_7
...
- **Toggle Delete** — `not-asserted` — currently lives in `collections/Attendance_Management_API.json`
