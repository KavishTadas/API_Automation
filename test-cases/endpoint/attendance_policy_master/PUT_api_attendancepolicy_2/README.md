...
Suite: `attendance_policy_master` · endpoint slug: `attendance_policy_master_put_api_attendancepolicy_2`
...
```python
caseRef = "put|/api/attendancepolicy/2|attendance policy master|update policy by id"
```
