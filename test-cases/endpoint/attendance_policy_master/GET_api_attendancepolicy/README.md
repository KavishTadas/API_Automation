...
Suite: `attendance_policy_master` · endpoint slug: `attendance_policy_master_get_api_attendancepolicy`
...
```python
caseRef = "get|/api/attendancepolicy|attendance policy master|get all policies"
```
