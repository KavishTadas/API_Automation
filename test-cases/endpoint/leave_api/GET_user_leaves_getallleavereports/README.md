...
Suite: `leave_api` · endpoint slug: `leave_api_get_user_leaves_getallleavereports`
...
```python
caseRef = "get|/user/leaves/getallleavereports|leave api|tc01/tc03 - get all leave reports and validate structure"
```
...
- **TC01/TC03 - Get all leave reports and validate structure**
  - `caseRef`: `get|/user/leaves/getallleavereports|leave api|tc01/tc03 - get all leave reports and validate structure`
  - assertion state: `asserted` — currently in `collections/Leave_API.json`
- **TC02 - Invalid token returns observed authorization status**
  - `caseRef`: `get|/user/leaves/getallleavereports|leave api|tc02 - invalid token returns observed authorization status`
  - assertion state: `asserted` — currently in `collections/Leave_API.json`
