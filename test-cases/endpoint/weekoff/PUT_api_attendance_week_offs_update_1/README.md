...
Suite: `weekoff` · endpoint slug: `weekoff_put_api_attendance_week_offs_update_1`
...
```python
caseRef = "put|/api/attendance/week-offs/update/1|attenedance-july2026|weekoffupdate"
```
