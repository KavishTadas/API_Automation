...
Suite: `weekoff` · endpoint slug: `weekoff_get_api_attendance_week_offs_getbyid_1`
...
```python
caseRef = "get|/api/attendance/week-offs/getbyid/1|attenedance-july2026|weekoffgetbyid"
```
