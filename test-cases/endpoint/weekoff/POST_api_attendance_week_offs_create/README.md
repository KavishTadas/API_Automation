...
Suite: `weekoff` · endpoint slug: `weekoff_post_api_attendance_week_offs_create`
...
```python
caseRef = "post|/api/attendance/week-offs/create|attenedance-july2026|weekoffmastercreate"
```
