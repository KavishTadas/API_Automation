...
Suite: `attendance_threshold` · endpoint slug: `attendance_threshold_post_api_attendance_status_threshold_create`
...
```python
caseRef = "post|/api/attendance/status-threshold/create|attendance status threshold api|create threshold"
```
