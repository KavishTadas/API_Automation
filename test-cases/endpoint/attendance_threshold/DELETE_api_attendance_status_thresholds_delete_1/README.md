...
Suite: `attendance_threshold` · endpoint slug: `attendance_threshold_delete_api_attendance_status_thresholds_delete_1`
...
```python
caseRef = "delete|/api/attendance/status-thresholds/delete/1|attendance status threshold api|delete threshold"
```
